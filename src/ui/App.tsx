...
export function App() {
  ...
  return <div className="app-shell">
    ...
    {dialog === 'help' && <Modal title="Всё начинается с одного здания" onClose={() => setDialog(null)}>
      ...
      <ol className="help-steps"><li>Нажмите на <strong>гараж</strong>. В карточке рядом со зданием купите площадку.</li><li>Нажмите на купленное здание, чтобы войти в интерьер. Выберите пустую ячейку и чип; базовый сервер стоит {money(SERVER.price)}.</li><li>Нажмите на сервер в сетке, чтобы изменить разгон, улучшить или продать именно его.</li><li>Установка требует свободной ячейки и мощности сети. Разгон доступен от 50 до 150%; превышение мощности при разгоне вызывает троттлинг.</li><li>Иконка модели в верхней панели ведёт на обучение: купите партию данных и загрузите её в модель.</li></ol>
